...
const translations = {
    ru: {
        ...
        hero_subtitle: "Прими взвешенное решение",
        ...
        review1_name: "Анастасия",
        review1_sub: "Руководитель методического отдела, конкурс «Инновации регионов», г. Нижний Новгород",
        review2_name: "Дмитрий",
        review2_sub: "Организатор международного фестиваля «Звёзды Поволжья», г. Казань",
        review3_name: "Екатерина",
        review3_sub: "Методист, конкурс «Современный урок – 2025», г. Воронеж",
    ...
    en: {
        ...
        hero_subtitle: "Make a Balanced Decision",
        go_to_app: "Go to App",
        plan_usual: "Standard",
        back_label: "Back",
        years: "years",
        ...
        review1_name: "Anastasia",
        review1_sub: "Head of Methodological Department, 'Regional Innovations' Contest, Nizhny Novgorod",
        review2_name: "Dmitry",
        review2_sub: "Organizer of the International Festival 'Stars of the Volga Region', Kazan",
        review3_name: "Ekaterina",
        review3_sub: "Methodologist, 'Modern Lesson – 2025' Contest, Voronezh",
